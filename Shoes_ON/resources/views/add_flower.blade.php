...
<style>
  * {
  ...
  body {
    ...
    align-items: center;
    background: url('https://www.shutterstock.com/image-photo/walk-modern-unisex-footwear-sneakers-600nw-2174646593.jpg');
...
<div class="logo">
  ...
  <div class="main-container">
    <!-- Poster Section -->
    <div class="poster">
      <img src="https://img.freepik.com/free-vector/e-commerce-concept-illustration_114360-539.jpg?w=740&t=st=1729144718~exp=1729145318~hmac=47e7c7fbe40b3b11cc5e8c06a1e9b93b1d09e4b2c4b704db86d08a20a5f5291a" alt="poster" class="poster-img">
    </div>
        ...
        <form method="post" action="">
          ...
          <div class="card-body">
            ...
            <div class="form-control">
              <label class="label">
                <span class="label-text">Name of Shoes</span>
              </label>
            ...
            <div class="form-control">
              <label class="label">
                <span class="label-text">Type of Shoes</span>
              </label>
